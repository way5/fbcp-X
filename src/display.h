...
#endif
// ERROR CHECK
#if defined(DMPI3501) || defined(KEDEI_V63_MPI3501)
#ifdef(USE_DMA_TRANSFERS)
#    error "DMA is unfortunately not possible with MPI3501 and KeDei MPI3501. Please disable with -DUSE_DMA_TRANSFERS=OFF."
#endif
#endif
// ERROR CHECK END
...
extern bool splashonclear;
extern uint64_t splashdelay;
extern bool splashTimeout;
extern bool firstpass;
extern uint64_t displayContentsLastChanged;
extern ConfigFile * config;
extern bool displayOff;
extern bool displayOffForced;
...
void ClearScreen(bool init = true);

// @fbcpX mandatory for every driver
